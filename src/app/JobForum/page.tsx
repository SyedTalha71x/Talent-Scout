...
import jobs from "@/utils/sampleJson/jobs.json"
        ...
        <div>
            <div className='relative bg-cover bg-center' style={{ backgroundImage: "url('/bg-jobpost.jpg')" }}>
                ...
                <div className='relative flex justify-center items-center text-center flex-col lg:p-36 md:p-26 sm:p-20 p-16'>
                    <h1 className='text-white lg:text-5xl md:text-4xl sm:text-2xl w-full text-2xl font-bold'>Find your Dream Job</h1>
                    <p className='text-gray-300 mt-1 text-lg w-full'>Discover Your Path to Success: Find Your Dream Job Today!</p>
                </div>
            </div>
            <div className="mt-[3%]">
                ...
                <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
                        <h1 className="lg:text-4xl md:text-3xl sm:text-xl text-xl font-bold tracking-tight text-gray-700">Find your Dream Job</h1>
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                            ...
                            <div className="lg:col-span-3">
                                {currentJobs.map((job, index) => (
                                    <div key={index} className=' rounded-lg shadow-md bg-slate-100 p-5 mb-6 transition-all cursor-pointer duration-500 hover:bg-blue-100'>
                                        <div className="flex gap-3 justify-start items-start">
                                            <div>
                                                <Image height={1000} width={1000} src={job.img} className='rounded-xl h-16 w-16 object-cover' alt="Company" />
                                            </div>
                                        ...
                                        <div className='flex items-center gap-5 mt-2'>
                                            ...
                                            <div className='flex gap-0.5'>
                                                <CiClock2 />
                                                <div className='text-[13px] text-gray-500'>{job.time}</div>
                                            </div>
                                        </div>
                                        <div className='mt-5'>
                                        ...
                                        <div className='mt-5 flex items-center gap-2'>
                                            {job.skills.map((skill: any, idx: any) => (
                                                <div key={idx} className='bg-slate-200 rounded-md py-1.5 px-4 text-gray-700 text-[12px]'>{skill}</div>
                                            ))}
                                        </div>
                                        <div className='mt-4 flex justify-between items-center'>
                                            ...
                                            <button className='bg-purple-600 text-white rounded-md py-2 px-6 text-sm nav-btns'>Apply Now</button>
                                        </div>
                                    </div>
                                ))}
