    ...
    <div className="lg:w-[90%] md:w-full sm:w-full w-full mx-auto">
      <div className="space-y-5 px-8 py-12">
        <div className="mt-5 text-left mb-14">
            <div>
                <h1 className="sm:text-3xl text-2xl font-extrabold title-font text-gray-800 mb-2">Explore our best Subscription Plans</h1>
                <p className="text-base leading-relaxed xl:w-full lg:w-full w-full mx-auto text-gray-500">Get started with out latest and cheap subscrition plans and pursue your career</p>
            </div>
        </div>
        <div className=" z-50 grid grid-cols-1  sm:grid-cols-2 lg:grid-cols-3 gap-5">
          <div className="rounded-[30px] md:rounded-[36px]  bg-[#f7f4f4] overflow-hidden border-[1px] border-gray-200 p-8 relative">
          ...
          <div className="rounded-[30px] md:rounded-[36px]  bg-[#f7f4f4] overflow-hidden border-[1px] border-gray-200 p-8 relative lg:col-span-2">
            <div className="h-full">
                ...
                <div className="flex flex-col flex-1 justify-between h-full space-y-5">
                  ...
                  <div className="pt-2">
                    <a
                      ...
                      type="button"
                      target="_blank"
                      className="appearance-none inline-flex hover:shadow-2xl transition-all duration-300 items-center group space-x-2.5 bg-purple-600 nav-btns text-white py-3 px-6 rounded-2xl cursor-pointer"
                    >
                      <span className="w-full font-semibold text-base">
                        Choose Free
                      </span>
